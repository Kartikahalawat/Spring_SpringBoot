...
public class ContactController {
    ...
    @GetMapping
    public ResponseEntity<String> fetchOpenContacts(@RequestParam @NotBlank(message="Status cannot be blank")
                                                        @Size(min =4, message = "Status length should be min 4 chars") String status){
